...
//      [ToggleUI] _EnableBlendModePreserveSpecularLighting("Enable Blend Mode Preserve Specular Lighting", Float) = 1.0
    ...
    #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/AxF/AxFProperties.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/AxF/AxF.hlsl"
            #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/AxF/ShaderPass/AxFDepthPass.hlsl"
            #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/AxF/AxFData.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/AxF/AxF.hlsl"
            #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/AxF/ShaderPass/AxFSharePass.hlsl"
            #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/AxF/AxFData.hlsl"
