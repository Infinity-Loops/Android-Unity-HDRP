    ...
    #include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/Decal/ShaderVariablesDecal.cs.hlsl"
#else

#include "Assets/Pipeline/com.unity.render-pipelines.high-definition/Runtime/Material/Decal/Decal.cs.hlsl"
