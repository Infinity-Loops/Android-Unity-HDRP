...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    partial class HDWizard
    {
        ...
        bool IsDXRShaderConfigCorrect()
        {
            ...
            bool found = false;
            using (StreamReader streamReader = new StreamReader("LocalAssets/Pipeline/com.unity.render-pipelines.high-definition-config/Runtime/ShaderConfig.cs.hlsl"))
            {
        ...
        void FixDXRShaderConfig(bool fromAsyncUnused)
        {
            ...
            else
            {
                ...
                string[] lines = System.IO.File.ReadAllLines("LocalAssets/Pipeline/com.unity.render-pipelines.high-definition-config/Runtime/ShaderConfig.cs.hlsl");
                ...
                File.WriteAllLines("LocalAssets/Pipeline/com.unity.render-pipelines.high-definition-config/Runtime/ShaderConfig.cs.hlsl", lines);
            }
        }
        ...
        const string k_LocalHdrpConfigPackagePath = "LocalAssets/Pipeline/com.unity.render-pipelines.high-definition-config";
