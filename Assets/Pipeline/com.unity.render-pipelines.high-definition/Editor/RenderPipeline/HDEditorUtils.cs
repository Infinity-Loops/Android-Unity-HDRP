...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDEditorUtils
    {
        internal const string FormatingPath =
            @"Assets/Pipeline/com.unity.render-pipelines.high-definition/Editor/USS/Formating";
        internal const string QualitySettingsSheetPath =
            @"Assets/Pipeline/com.unity.render-pipelines.high-definition/Editor/USS/QualitySettings";
        internal const string WizardSheetPath =
            @"Assets/Pipeline/com.unity.render-pipelines.high-definition/Editor/USS/Wizard";
