...
* **Manual**: In your Project's directory, move and rename the folder "**/Library/PackageCache/com.unity.render-pipelines.high-definition-config@[versionnumber]**" to "**/Assets/Pipeline/com.unity.render-pipelines.high-definition-config**".
