...
The Hair Shader does not have an Inspector implementation, like the [Lit Shader](Lit-Shader.html) does. As such, you need to use the node-based Shader editor, [Shader Graph](https://docs.unity3d.com/Assets/Pipeline/com.unity.shadergraph@latest/index.html), to configure a Hair Material.
...
The following table describes the input ports on an Hair Master node, including the property type and Shader stage used for each port. For more information on Shader stages, see [Shader stage](https://docs.unity3d.com/Assets/Pipeline/com.unity.shadergraph@6.9/manual/Shader-Stage.html).
