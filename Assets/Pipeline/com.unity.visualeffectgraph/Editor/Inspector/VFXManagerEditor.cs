...
class VFXManagerEditor : Editor
{
    ...
    public static void CheckVFXManager()
    {
        ...
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_IndirectShader",     "Assets/Pipeline/com.unity.visualeffectgraph/Shaders/VFXFillIndirectArgs.compute");
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_CopyBufferShader",   "Assets/Pipeline/com.unity.visualeffectgraph/Shaders/VFXCopyBuffer.compute");
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_SortShader",         "Assets/Pipeline/com.unity.visualeffectgraph/Shaders/Sort.compute");
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_StripUpdateShader",  "Assets/Pipeline/com.unity.visualeffectgraph/Shaders/UpdateStrips.compute");
