...
namespace UnityEditor.VFX
{
    static class VFXCodeGenerator
    {
        ...
        static private StringBuilder Build(VFXContext context, string templatePath, VFXCompilationMode compilationMode, VFXContextCompiledData contextData)
        {
            ...
            string renderPipeCommon = context.doesIncludeCommonCompute ? "Assets/Pipeline/com.unity.visualeffectgraph/Shaders/Common/VFXCommonCompute.hlsl" : VFXLibrary.currentSRPBinder.runtimePath + "/VFXCommon.hlsl";
            ...
            perPassIncludeContent.WriteLine("#include \"Assets/Pipeline/com.unity.visualeffectgraph/Shaders/VFXCommon.hlsl\"");
