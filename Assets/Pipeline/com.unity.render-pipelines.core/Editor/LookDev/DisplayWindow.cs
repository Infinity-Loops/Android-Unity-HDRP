...
namespace UnityEditor.Rendering.LookDev
{
    ...
    partial class DisplayWindow : EditorWindow, IViewDisplayer
    {
        ...
        {
            internal const string k_IconFolder = @"Assets/Pipeline/com.unity.render-pipelines.core/Editor/LookDev/Icons/";
            internal const string k_uss = @"Assets/Pipeline/com.unity.render-pipelines.core/Editor/LookDev/DisplayWindow.uss";
            internal const string k_uss_personal_overload = @"Assets/Pipeline/com.unity.render-pipelines.core/Editor/LookDev/DisplayWindow-PersonalSkin.uss";
