    ...
    Fallback Off
        ...
        public override void OnImportAsset(AssetImportContext ctx)
        {
            ...
            foreach (var sourceAssetDependencyPath in sourceAssetDependencyPaths.Distinct())
            {
                ...
                if (!sourceAssetDependencyPath.StartsWith("Assets/Pipeline/") && !sourceAssetDependencyPath.StartsWith("Assets/"))
                {
        ...
        static ShaderGraphVfxAsset GenerateVfxShaderGraphAsset(VfxMasterNode masterNode)
        {
            ...
            codeSnippets.Add($"#include \"Assets/Pipeline/com.unity.shadergraph/ShaderGraphLibrary/Functions.hlsl\"{nl}");
