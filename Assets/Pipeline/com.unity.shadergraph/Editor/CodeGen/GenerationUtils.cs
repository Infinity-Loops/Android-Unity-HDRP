...
namespace UnityEditor.ShaderGraph
{
    static class GenerationUtils
    {
            ...
            List<Dependency[]> dependencies, string resourceClassName, string assemblyName)
        {
            ...
            string templatePath = "Assets/Pipeline/com.unity.render-pipelines.universal/Editor/ShaderGraph/Templates";
        ...
        {
            var basePath = "Assets/Pipeline/com.unity.shadergraph/Editor/Templates/";
