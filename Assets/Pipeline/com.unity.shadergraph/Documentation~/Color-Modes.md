...
For each project, you can override preset colors in the **Category** and **Precision** modes. Unity uses a `.uss` style sheet and Hex color codes to set colors. The default style sheet in your project is  `Assets/Pipeline/com.unity.shadergraph/Editor/Resources/Styles/ColorMode.uss`.
